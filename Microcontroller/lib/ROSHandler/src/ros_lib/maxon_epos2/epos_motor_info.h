#ifndef _ROS_maxon_epos2_epos_motor_info_h
#define _ROS_maxon_epos2_epos_motor_info_h
...
namespace maxon_epos2
{
  ...
  class epos_motor_info : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "maxon_epos2/epos_motor_info"; };
    const char * getMD5(){ return "2cf6c2ef6d4814960f7bd2c448525593"; };
