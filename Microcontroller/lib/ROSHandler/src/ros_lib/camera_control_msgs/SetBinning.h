...
static const char SETBINNING[] = "camera_control_msgs/SetBinning";
  ...
  class SetBinningRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SETBINNING; };
    const char * getMD5(){ return "070d3ce2d671acce3b96edb95ae60995"; };
  ...
  class SetBinningResponse : public ros::Msg
  {
    ...
    const char * getType(){ return SETBINNING; };
    const char * getMD5(){ return "519ec992dd33973d0740b5940161bf8e"; };
