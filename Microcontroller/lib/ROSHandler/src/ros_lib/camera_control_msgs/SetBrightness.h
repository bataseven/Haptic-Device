...
static const char SETBRIGHTNESS[] = "camera_control_msgs/SetBrightness";
  ...
  class SetBrightnessRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SETBRIGHTNESS; };
    const char * getMD5(){ return "1f8cc426d8d4e41959f6306162a714c3"; };
  ...
  class SetBrightnessResponse : public ros::Msg
  {
    ...
    const char * getType(){ return SETBRIGHTNESS; };
    const char * getMD5(){ return "62110aff39d46cf6a4ab77f09896582b"; };
