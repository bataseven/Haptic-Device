...
static const char SETEXPOSURE[] = "camera_control_msgs/SetExposure";
  ...
  class SetExposureRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SETEXPOSURE; };
    const char * getMD5(){ return "881807b9f62e6919695085297c872d67"; };
  ...
  class SetExposureResponse : public ros::Msg
  {
    ...
    const char * getType(){ return SETEXPOSURE; };
    const char * getMD5(){ return "f0624b49b89ef97572f8db48c91665b2"; };
